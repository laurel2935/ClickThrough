 ...
 * <p>
 **/
public final class SimpleAnalyzer_Var extends Analyzer {
   ...
   */
  public SimpleAnalyzer_Var(Version matchVersion) {
  ...
  protected TokenStreamComponents createComponents(final String fieldName,
      final Reader reader) {
    return new TokenStreamComponents(new LowerCaseTokenizer_Var(matchVersion, reader));
  }
}
